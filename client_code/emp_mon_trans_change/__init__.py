...
class emp_mon_trans_change(emp_mon_trans_changeTemplate):
  ...
  def button_1_click(self, **event_args):
    ...
    # fxd_attn_bonus,mandays,weekly_off,paid_holiday,layoff,absent = anvil.server.call('attn_bonus',self.row['trans_comp_code'],self.row['trans_empid'])
    # print(fxd_attn_bonus,mandays,weekly_off,paid_holiday,layoff,absent)
