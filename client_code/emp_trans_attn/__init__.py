...
class emp_trans_attn(emp_trans_attnTemplate):
  def __init__(self, **properties):
    ...
    self.text_box_6.text = self.text_box_7.text = self.text_box_8.text = 0

  def sum_tb_values(self):
    self.text_box_11.text = int(self.text_box_1.text) + int(self.text_box_2.text) + int(self.text_box_3.text) 
    self.text_box_11.text = int(self.text_box_11.text) + int(self.text_box_4.text) + int(self.text_box_5.text)
    self.text_box_11.text = int(self.text_box_11.text) + int(self.text_box_6.text) + int(self.text_box_7.text) 
    self.text_box_11.text = int(self.text_box_11.text) + int(self.text_box_8.text)
